...
var EvermeetCxInstaller = class {
  ...
  async downloadTool(release) {
    ...
    await (0, import_promises.mkdir)(dirToCache, { recursive: true });
    await (0, import_promises.rename)(path7.join(ffmpegExtracted, "ffmpeg"), path7.join(dirToCache, "ffmpeg"));
    await (0, import_promises.rename)(path7.join(ffprobeExtracted, "ffprobe"), path7.join(dirToCache, "ffprobe"));
...
async function run() {
  try {
    ...
    await (0, import_promises3.chmod)(ffmpegPath, "755");
    await (0, import_promises3.chmod)(ffprobePath, "755");
    addPath(output.path);
